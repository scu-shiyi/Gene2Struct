...
class OptionList(UserList.UserList):
	...
	### Input files ###
        ...
        #movingSidechains
        self.add_option('--frozenSidechain', type='string', dest='frozenSC',
                        help='moving sidechains in the receptor that are frozen', default=None,
                        group="receptor",
                        enableGUI=enableGUI)
	...
	## dimension of the docking box
        ...
        self.add_option('--useXmlBox',type='choice',
                        ...
                        enableGUI=enableGUI)
        ##
        self.add_option('--fixMaps',type='choice',
                        dest='fixMaps',
                        default=False,
                        help='Set to True to fixMaps',
                        group="ligand",
                        enableGUI=enableGUI)
        ...
        self.add_option('--GAminimize', type='{}', dest='GAminimize',
                        ...
                        group="score",
                        default=None)
        self.add_option('--GAHighMinimize', type='{}', dest='GAHighMinimize',
                        help='list of high minimize parameters [nbsteps, noImproveStop, max_steps, MAX_FAIL, MINVAR, search_rate]', 
                        group="score",
                        default=None)
	...
	## Output files ##
        ...
        self.add_option('--savePopulationMols',type='list', default=[],
                        ...
                        group="log",
                        enableGUI=enableGUI)
        self.add_option('--savePopulationMolsBest',type='list', default=[],
                        dest='savePopulationMolsBest',
                        help='save the output to file',
                        group="log",
                        enableGUI=enableGUI)      
	...
	self.add_option('--gens',type='int', dest='GA_gens',
        ...
        self.add_option('--p_localsearch',type='float', \
                        ...
                        default=0.3, enableGUI=enableGUI,
                        group="GA",
                        help='probability of modifying a scripts in LS')
        ...
        self.add_option('--coarseStep', type='int', dest='coarseStep',
                        help='coarse sampling step for anchor points', 
                        group="score",
                        default=1)

        self.add_option('--fixedLigandRotationAndTranslation',type='choice',
                        dest='fixedLigandRotationAndTranslation',
                        default=False,
                        #choices=['AutoDock4.2'],
                        help='freeze ligand Rotation and translation',
                        group="ligand",
                        )
...
class Params:
	...
	"""
        ...
        # If there are flexible side chains
        ...
        # If there are frozen flexible side chains
        ## if setting.has_key("Receptor"):
        ##     if not setting.has_key("frozenSC"):
        ##         if (setting['FR_L'] or setting['RR_FR'] or setting['FR_FR']) or \
	## 		(setting['FR_L_Fitness'] or setting['RR_FR_Fitness'] or setting['FR_FR_Fitness']):
        ##         	print "Error: a rigid receptor was specified. Please set FR_L, RR_FR, FR_FR \
        ##                 FR_L_Fitness, R_FR_Fitness, FR_FR_Fitness to be False"

...
# $Header: /mnt/raid/services/cvs/python/packages/share1.5/AutoDockTools/DockingParameters.py,v 1.106.2.3 2016/02/11 09:24:07 annao Exp $
#
#
...
class DockingParameters(UserDict.UserDict):
    def __init__(self, receptor_filename='', ligand_filename='', flexres_filename=''):
        ...
        self[ 'ga_mutation_rate' ] = {
            ...
            'default' : 0.02,
            'comment' : "rate of scripts mutation",
            'value'   : 0.02
        }
        self[ 'ga_num_evals' ] = {

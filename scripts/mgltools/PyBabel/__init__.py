...
#############################################################################
#
# $Header: /mnt/raid/services/cvs/python/packages/share1.5/PyBabel/__init__.py,v 1.10 2006/03/15 00:45:52 annao Exp $
#
...
II - Gasteiger charges calculations:
  ...
  example:
      ...
      >>> babel.assignHybridization(allAtoms)
      >>>
      >>> from scripts.mgltools.PyBabel.gasteiger import Gasteiger
      >>> Gast = Gasteiger()

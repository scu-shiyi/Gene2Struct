...
#############################################################################
#
# $Header: /mnt/raid/services/cvs/python/packages/share1.5/PyBabel/aromatic.py,v 1.3 2008/11/15 00:14:40 sargis Exp $
#
...
from scripts.mgltools.PyBabel.util import distance, bond_angle

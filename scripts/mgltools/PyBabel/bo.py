...
#############################################################################
#
# $Header: /mnt/raid/services/cvs/python/packages/share1.5/PyBabel/bo.py,v 1.4 2002/10/22 23:11:38 sanner Exp $
#
...
from scripts.mgltools.PyBabel.atomTypes import TypeConverter

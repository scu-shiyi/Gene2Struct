...
import os
from scripts.mgltools.MolKit.molecule import AtomSet, BondSet
from scripts.mgltools.MolKit.bondSelector import AromaticCycleBondSelector2
from scripts.mgltools.AutoDockTools.sol_par import solvs
...
"""
    ...
    def setAutoDockElements(self, mol, typeAtoms=0, reassign=False, splitAcceptors=False):
        ...
        ats_with_babel_type = list(filter(lambda x: hasattr(x, 'babel_type'), mol.allAtoms))

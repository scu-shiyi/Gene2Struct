...
#
# $Header: /mnt/raid/services/cvs/python/packages/share1.5/mglutil/math/statetocoords.py,v 1.11.10.1 2016/02/11 23:15:05 annao Exp $
#
...
from scripts.mgltools.mglutil.math.kinematics import Kinematics

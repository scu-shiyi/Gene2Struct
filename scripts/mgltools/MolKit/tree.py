...
#
# $Header: /mnt/raid/services/cvs/python/packages/share1.5/MolKit/tree.py,v 1.72.2.1 2015/08/29 01:26:36 sanner Exp $
#
...
from scripts.mgltools.MolKit.listSet import ListSet
...
"""
        from scripts.mgltools.MolKit.stringSelector import StringSelector
...
##         assert type(Klass) is types.ClassType
    ...
    def split(self, nodes, nameExt='_copy1'):
        ...
        # Ensure all uses of filter(...) assigned to result are materialized as lists if needed elsewhere
...
#
# $Header: /mnt/raid/services/cvs/python/packages/share1.5/MolKit/bondSelector.py,v 1.26.2.1 2016/02/12 01:12:48 annao Exp $
#
...
from scripts.mgltools.MolKit.molecule import Bond, BondSet, AtomSet
    ...
    def select(self, bnds, cutoff=7.5):
        ...
        for ring in rf.rings:
            ...
            for bnd in blist:
                ...
                z2 = list(filter(lambda x:x!=bnd and x.atom1==at or x.atom2==at, blist))
                bnd.nextbond = z2[0]
                neighbor = z2[0].atom1
                if neighbor==at:
                    neighbor = z2[0].atom2

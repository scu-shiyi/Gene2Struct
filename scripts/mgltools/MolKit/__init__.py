...
#
#$Header: /mnt/raid/services/cvs/python/packages/share1.5/MolKit/__init__.py,v 1.29.2.1 2015/08/29 01:26:36 sanner Exp $
#
...
def Read(filename, modelsAs='molecules'):
    ...
    # from scripts.mgltools.MolKit.mmcifParser import MMCIFParser
    ext = filename.split('.')
    if ext[-1]=='pdb':
...
if __name__=='__main__':
    file_name = "/Users/sy/Desktop/test/Salidroside.pdb"
    mol = Read(file_name)


# def WritePDB(filename,node):
#     from scripts.mgltools.MolKit.pdbWriter import PdbWriter
#     writer = PdbWriter()
...
# """
#     from scripts.mgltools.MolKit.molecule import Atom, AtomSet
#     from scripts.mgltools.MolKit.protein import Protein, Chain, Residue
#
#
...
#
# ##  from scripts.mgltools.MolKit.protein import ProteinSet, Protein,ResidueSet, Residue, ChainSet, Chain
# ##  from scripts.mgltools.MolKit.molecule import AtomSet, Atom, MoleculeSet, Molecule
#

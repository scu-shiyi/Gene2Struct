...
#
# $Header: /mnt/raid/services/cvs/python/packages/share1.5/MolKit/hydrogenBuilder.py,v 1.7 2008/12/08 18:04:17 sargis Exp $
#
...
from scripts.mgltools.MolKit.molecule import Atom, AtomSet, Bond
from scripts.mgltools.PyBabel.atomTypes import AtomHybridization
from scripts.mgltools.PyBabel.addh import AddHydrogens
from scripts.mgltools.PyBabel.cycle import RingFinder
from scripts.mgltools.PyBabel.aromatic import Aromatic
from scripts.mgltools.PyBabel.bo import BondOrder
        ...
        if self.method=='withBondOrder':
            ...
            for ind in range(len(mol.rings.rings)):
                ...
                for b in r['bonds']:
                    ...
                    if b not in mol.allAtoms.bonds:
                        mol.rings.bondRings[b] = [ind]
                    else:
